...
/***/ function(module, exports, __webpack_require__) {
	...
	var HoleModal = __webpack_require__(23);
	    ...
	    return (
	      React.createElement("div", {className: "app"}, 
	        React.createElement("div", {className: "top"}, 
	          React.createElement(Rounds, {onSelect: this.selectRound})
	        ), 
	        React.createElement("div", {className: "top"}, 
	           this.state.round.id ? React.createElement(Scorecard, {round: this.state.round}) : null
	        ), 
	         this.state.modalData ? React.createElement(HoleModal, {data: this.state.modalData}) : null
	      ));
	  }
	});
	  ...
	  render: function() {
	    return (
	      React.createElement("div", null, 
	        ...
	        React.createElement(RoundList, {data: this.state.data, onSelect: this.props.onSelect})
	      )
	    );
	  }
	});
	...
	var RoundList = React.createClass({displayName: "RoundList",
	  ...
	  render: function() {
	    ...
	    var roundNodes = this.props.data.map(function(round, idx) {
	      return (
	        React.createElement(Round, {round: round, key: idx, onSelect: selectFn})
	      );
	    });
	    return (
	...
	var Round = React.createClass({displayName: "Round",
	  ...
	  render: function() {
	    ...
	    return (
	      React.createElement("div", {onClick: this.select}, 
	        React.createElement("div", {className: "middle"}, 
	          React.createElement("img", {src: map, width: "100"})
	        ), 
	        React.createElement("div", {className: "middle"}, 
	...
	var HoleList = __webpack_require__(24); 
	    ...
	    return (
	      React.createElement("div", {className: "modal"}, 
	        React.createElement("div", {className: "dialog"}, 
	          React.createElement("div", null, 
	            React.createElement("div", {className: "hole-map", style: style})
	          ), 
	          React.createElement("div", {className: "info"}, 
	            React.createElement("div", null, this.props.data.hole.number), 
	            React.createElement("div", null, this.props.data.hole[this.props.data.round.tees]), 
	            React.createElement("div", null, this.props.data.hole.par), 
	            React.createElement("div", {className: 'over-under over-under-' + this.props.data.hole.over_under}, this.props.data.hole.score), 
	            React.createElement("div", {dangerouslySetInnerHTML: {__html: fir}}), 
	            React.createElement("div", {dangerouslySetInnerHTML: {__html: gir}}), 
	            React.createElement("div", null, this.props.data.hole.putts)
	          )
	        )
	      )
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	/** @jsx React.DOM */var React = __webpack_require__(18);
	var utils = __webpack_require__(21);
	var Hole = __webpack_require__(25);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "module.exports",
	  ...
	  render: function() {
	    ...
	    return (
	      React.createElement("div", {style:  { textAlign: this.props.data.align || 'center'}, onClick: this.props.data.id && this.open}, 
	        React.createElement("div", {className: "hole-map", style: this.props.data.id ? style : null}), 
	        React.createElement("div", {className: "info"}, 
