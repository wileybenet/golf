...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    return (
	      React.createElement("div", {className: "app"}, 
	        ...
	        React.createElement("div", {className: "content-block"}, 
	         ...
	         this.state.modal === 'round' ? React.createElement(RoundModal, {close: this.closeModal}) : null
	      )
	    );
	  }
	});

	var Rounds = React.createClass({displayName: "Rounds",
	  componentDidMount: function() {
	...
	var RoundList = React.createClass({displayName: "RoundList",
	  addRound: function() {
	  ...
	  render: function() {
	    var roundNodes = this.props.data.map(function(round, idx) {
	      return (
	        React.createElement(Round, {round: round, key: idx})
	      );
	    });
	    return (
	      React.createElement("div", {className: "round-list"}, 
	        React.createElement("div", {className: "round-actions"}, 
	          React.createElement("span", {className: "small btn", onClick: this.addRound}, "add round")
	        ), 
	        roundNodes
	      ));
	  }
	...
	var Round = React.createClass({displayName: "Round",
	  ...
	  render: function() {
	    ...
	    return (
	      React.createElement("div", {className: classes, onClick: this.select}, 
	         selected ? React.createElement(Arrow, {dir: "left"}) : null, 
	        React.createElement("div", {className: "middle"}, 
	          React.createElement("img", {src: map, height: "60"})
	        ), 
	        React.createElement("div", {className: "middle round-info"}, 
	          this.props.round.name, " ", React.createElement("span", {className: "small"}, "#", this.props.round.round_number), 
	          React.createElement("div", {className: "small"}, this.props.round.date_str), 
	          React.createElement("div", {className: "small"}, "Par ", this.props.round.total_par), 
	          React.createElement("div", {className: "small caps"}, this.props.round.tees, " ", this.props.round[this.props.round.tees + '_dist'], " yds"), 
	          React.createElement("div", {className: "small"}, toPar, " ", overUnder)
	        )
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "46b66537eefdb35bff050214143e4ff2.png"

/***/ },
/* 14 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "f7ed6a5c210d33551e5cf02434a3b304.png"

/***/ },
/* 15 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "2453205f57949cd869ccb77a7a7f97f1.png"

/***/ },
/* 16 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "6e0418627df0159500f7a3b18448a825.png"

/***/ },
/* 17 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "f92d2c9f5dbdc9c708aad4f0b9318e75.png"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cometRouter = __webpack_require__(20);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var utils = __webpack_require__(21);
	var emitter = __webpack_require__(22);
	var Hole = __webpack_require__(24);
	...
	module.exports = React.createClass({displayName: "module.exports",
	  ...
	  render: function() {
	    ...
	    var holeNodes = this.props.data.map(function(hole, idx) {
	      return (
	        React.createElement("div", {className: "hole", key: idx}, 
	          React.createElement(Hole, {data: hole, round: round})
	        )
	      );
	    });
	    ...
	    holeNodes.unshift((
	      React.createElement("div", {className: "hole summary", key: "headers"}, 
	        React.createElement(Hole, {data: headers, round: round})
	      )
	    ));
	    
	    holeNodes.splice(10, 0, (
	      React.createElement("div", {className: "hole summary", key: "front"}, 
	        React.createElement(Hole, {data: frontNine, round: round})
	      )
	    ));

	    holeNodes.push((
	      React.createElement("div", {className: "hole summary", key: "back"}, 
	        React.createElement(Hole, {data: backNine, round: round})
	      )
	    ));

	    holeNodes.push((
	      React.createElement("div", {className: "hole summary", key: "all"}, 
	        React.createElement(Hole, {data: eighteen, round: round})
	      )
	    ));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "module.exports",
	  ...
	  render: function() {
	    ...
	    return (
	      React.createElement("div", {className: this.props.data.id ? 'hole-data' : 'hole-summary', style:  { textAlign: this.props.data.align || 'center'}, onClick: this.props.data.id && this.open}, 
	        this.props.data.id ? React.createElement("img", {className: "hole-map", src: src}) : React.createElement("div", {className: "hole-map"}), 
	        React.createElement("div", {className: "info"}, 
	          React.createElement("div", null, this.props.data.number), 
	          React.createElement("div", null, this.props.data[this.props.round.tees]), 
	          React.createElement("div", null, this.props.data.par), 
	          React.createElement("div", {className: overUnder}, this.props.data.score), 
	          React.createElement("div", {dangerouslySetInnerHTML: {__html: fir}}), 
	          React.createElement("div", {dangerouslySetInnerHTML: {__html: gir}}), 
	          React.createElement("div", null, this.props.data.putts)
	        )
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	/** @jsx React.DOM */var React = __webpack_require__(18);
	var paper = __webpack_require__(26);
	        ...
	        React.createElement("div", {className: "dialog", onClick: this.prevent}, 
	          ...
	          React.createElement("div", {className: "hole-focus"}, 
	            React.createElement("table", {className: "hole-info top small"}, 
	              ...
	              React.createElement("tr", null, 
	                React.createElement("td", null, 
	                  React.createElement("div", {className: "hole-number"}, 
	                    this.props.data.hole.number, 
	                    React.createElement("span", {className: 'over-under inline over-under-' + this.props.data.hole.over_under}, this.props.data.hole.score)
	                  )
	                ), 
	                React.createElement("td", null)
	              ), 
	            ...
	            React.createElement("div", {className: "hole-map-wrapper top"}, 
	              React.createElement("img", {className: "hidden", id: "modal-hole-img", src: img, width: "260"}), 
	              React.createElement("canvas", {id: "modal-hole-canvas", height: "350", width: "250"}), 
	               this.state.editing ? React.createElement("div", {className: "btn save small", onClick: this.save}, "save") : React.createElement("div", {className: "btn edit small", onClick: this.edit}, "edit"), 
	...
	module.exports = React.createClass({displayName: "module.exports",
	  ...
	  render: function() {
	    var courseOptions = this.state.courses.map(function(course) {
	      return (
	        React.createElement("option", {value: course.id}, course.name)
	      );
	    });
	    courseOptions.unshift(React.createElement("option", {value: "0"}, "course"));
	    var cols = this.state.holes.map(function(hole, idx) {
	      var i = idx + 1;
	      return (
	        React.createElement("div", {className: "middle"}, 
	          React.createElement("div", {className: "center"}, i), 
	          React.createElement("input", {type: "text", tabIndex: i, onChange: this.setValue(hole, 'score')}), 
	          React.createElement("input", {type: "text", tabIndex: i+18, onChange: this.setValue(hole, 'fir')}), 
	          React.createElement("input", {type: "text", tabIndex: i+36, onChange: this.setValue(hole, 'gir')}), 
	          React.createElement("input", {type: "text", tabIndex: i+54, onChange: this.setValue(hole, 'putts')})
	        )
	      );
	    }.bind(this));
	    return (
	      React.createElement("div", {className: "modal", onClick: this.props.close}, 
	        React.createElement("div", {className: "dialog wide", onClick: this.prevent}, 
	          React.createElement("div", null, 
	            React.createElement("select", {onChange: this.setCourse}, 
	              courseOptions
	            ), 
	            React.createElement("select", {onChange: this.setTees}, 
	              React.createElement("option", {value: "pros"}, "Pros"), 
	              React.createElement("option", {value: "tips"}, "Tips")
	            )
	          ), 
	           this.state.holes.length ? React.createElement("div", {className: "table-wrapper"}, 
	            React.createElement("div", {className: "middle"}, 
	              React.createElement("div", null, "Hole"), 
	              React.createElement("div", null, "Score"), 
	              React.createElement("div", null, "FIR"), 
	              React.createElement("div", null, "GIR"), 
	              React.createElement("div", null, "Putts")
	            ), 
	            cols
	          ) : null, 
	          React.createElement("div", {className: "modal-submit"}, 
	            React.createElement("span", {className: "btn", onClick: this.submit}, "submit")
	          )
	        )
	      )
	    );
